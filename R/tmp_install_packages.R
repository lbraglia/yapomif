...
#'
#' originally function sopkgs in package overflow
#' 
...
#' sopkgs("ggplot2")
#' }
tmp_install.packages <- function(package, dependencies=TRUE, ...) {
  path <- tempdir()
...
## Version: 0.2-1
## Date: 2013-03-24
## Title: Utility functions for answering R question on
## StackOverflow
## Authors@R: c(person("Sebastian", "Campbell", role = c("aut",
##                                                  "cre"),
##                         email="sebastian.campbell@sydney.edu.au"),
##                  person("Ananda", "Mahto", role="aut",
##                             email="ananda@mahto.info"),
##                  person("Julien", "Barnier", role="aut",
##                             email="julien@nozav.org"),
##                  person("Tyler", "Rinker", role="aut"))
## Author: Sebastian Campbell, Ananda Mahto, Julien Barnier
## Maintainer: Sebastian Campbell <sebastian.campbell@sydney.edu.au>
##     Description: On StackOverflow, there are several tasks which
## are performed
##     repeatedly including temporarily installing a package and
## copying code into
##     an R session. This package automates some of these processes,
## making
